      ...
      "/guide/": [
        {
          ...
          items: [
            ...
            { text: "引言", link: "/guide/02-0" },
            {
              text: "第一章 前端开发简介",
              collapsed: true,
              items: [{ text: "前端开发简介", link: "/guide/03-i" }],
            },
            {
              text: "第二章 基础 Web 技术",
              collapsed: true,
              items: [
                {
                  text: "Internet 互联网",
                  link: "/guide/04-ii-web-ii-1-internet",
                },
                ...
                {
                  text: "JavaScript",
                  link: "/guide/08-ii-web-ii-5-javascript",
                },
                {
                  text: "TypeScript",
                  link: "/guide/09-ii-web-ii-6-typescript-javascript",
                },
              ],
            },
            {
              ...
              items: [
                {
                  text: "Git & GitHub",
                  link: "/guide/10-iii-iii-1-git-github",
                },
                ...
                { text: "现代构建工具", link: "/guide/14-iii-iii-5" },
                {
                  ...
                  link: "/guide/15-iii-iii-6-linter-eslint-formatter-prettier",
                },
            ...
            },
            {
              ...
              items: [
                {
                  text: "框架概览",
                  link: "/guide/20-iv-ui-iv-1-ui-reactvueangularsveltesolidjslit",
                },
                {
                  text: "Web Components",
                  link: "/guide/21-iv-ui-iv-2-web-components",
                },
                ...
                {
                  text: "数据获取",
                  link: "/guide/26-iv-ui-iv-7-swrtanstack-queryaxiosfetch-api",
                },
                {
                  text: "服务器状态与客户端状态",
                  link: "/guide/27-iv-ui-iv-8",
                },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "性能监控",
                  link: "/guide/30-v-v-2-performance-monitoring",
                },
                ...
                {
                  text: "国际化",
                  link: "/guide/37-v-v-9-internationalization-i18n-localization-l10n",
                },
                ...
                {
                  text: "DevOps",
                  link: "/guide/43-v-v-15-devops-for-Frontend",
                },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "WebAssembly",
                  link: "/guide/46-vi-vi-2-webassembly-wasm-web",
                },
                {
                  text: "跨端开发",
                  link: "/guide/47-vi-vi-3-react-native-capacitor-electron-tauri",
                },
                ...
                { text: "AI/ML", link: "/guide/51-vi-vi-7-ai-ml" },
                {
                  ...
                  link: "/guide/52-vi-vi-8-cloudflare-workersvercel-edge-functionsdeno-deploy",
                },
                {
                  text: "设备集成 API",
                  link: "/guide/53-vi-vi-9-web-bluetoothweb-usbwebhidgeneric-sensor-api",
                },
              ],
            },
            {
              text: "第七章 持续学习和职业发展",
              collapsed: true,
              items: [{ text: "持续学习和职业发展", link: "/guide/54-vii" }],
            },
            {
              text: "第八章 结语",
              collapsed: true,
              items: [{ text: "结语", link: "/guide/55-viii" }],
            },
            {
              text: "附录",
              collapsed: true,
              items: [{ text: "学习资料汇总", link: "/guide/56-a" }],
            },
          ],
        },
      ],
