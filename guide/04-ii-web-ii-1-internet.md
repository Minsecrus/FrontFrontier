...
在过去，前端开发者判断“一个新特性能不能用”，通常要反复在 [Can I Use](https://caniuse.com/) 和浏览器版本表里来回比对。  
...
例如，像 **Container Queries**、**`:has()`**、**CSS Nesting** 这样的能力，更适合用 Baseline 的语言去讨论，而不是继续停留在“新特性，一般别用”的老经验上。  
