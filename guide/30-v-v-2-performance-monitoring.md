...
这在 2026 年已经不再是 [Webpack](https://webpack.js.org/) 独占的话题：无论你使用 Vite、Rspack、Webpack 还是框架内置构建链，都应该有一套查看产物组成、区分首屏关键资源、识别第三方库膨胀的办法。
...
到 2026 年，性能优化已经不只发生在“页面加载之后”，而是越来越多地发生在**用户点击之前**。  
