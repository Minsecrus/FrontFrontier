...
- [**WebGL**](https://www.khronos.org/webgl/)：JavaScript API，利用 GPU 在浏览器中渲染交互式 2D 和 3D 图形。复杂，底层。
- [**WebGPU**](https://www.w3.org/TR/webgpu/)：WebGL 的继任者，与现代 GPU 的兼容性更好，支持 GPGPU 计算，操作更快，并可访问更高级的 GPU 功能。
- [**Three.js**](https://threejs.org/)：基于 JavaScript 的 WebGL 引擎，简化了 3D 场景的创建，适用于通用 Web 动画。
...
| [**WebGPU**](https://www.w3.org/TR/webgpu/)  | 低级 API                            | 高性能计算，现代 3D 图形，GPGPU                  | [WebGPU](https://www.w3.org/TR/webgpu/)                                         | 陡峭     | 现代 GPU 兼容性，并行计算                                                     | 无                        |
...
- [**WebXR Device API**](https://developer.mozilla.org/en-US/docs/Web/API/WebXR_Device_API)：在 Web 应用中启用增强现实 (AR) 和虚拟现实 (VR) 体验，可对接混合现实硬件。
